...
import { LocalesAlquiladosComponent } from './components/local/locales-alquilados/locales-alquilados.component';
export const routes: Routes = [
    ...
    { path: 'propietario-dashboard', component: PropietarioDashboardComponent, canActivate: [AuthGuard], children: [
      ...
      { path: 'locales-alquilados', component: LocalesAlquiladosComponent },
